...
const PLAZAS = [
  {
    ...
    disponibles: 18,
    highlights: ['Concepto biofílico', '2 niveles', '40% áreas verdes', 'Enganche desde $147,000 MXN'],
    href: '/plazas/gardens',
    color: '#FAB413',
  },
  {
      ...
      itemListElement: [
        {
          ...
          item: {
            ...
            description: 'Locales comerciales en venta en Cancún desde 32 m². Concepto biofílico, 2 plantas, 40% áreas verdes. Entrega JUN–SEP 2027.',
        ...
        },
        {
          ...
          item: {
            ...
            url: 'https://www.quattroplaza.mx/plazas/long-island',
      ...
      <section className="bg-bg py-16 md:py-20">
        <div className="container-wrap max-w-3xl">
          ...
          <div className="mt-6 space-y-4 text-[15px] font-light leading-relaxed text-ink-2">
            ...
            <p>
              <strong>Quattro Plaza Center</strong> ofrece locales comerciales en venta en Cancún en dos plazas de diseño premium: <strong>Gardens</strong>, con arquitectura biofílica y áreas verdes, y <strong>Long Island</strong>, con 120 metros lineales de frente comercial en uno de los corredores con mayor tráfico de la ciudad.
            </p>
            <p>
